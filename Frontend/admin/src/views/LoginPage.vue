  ...
  <main class="auth">
    ...
    <div class="auth__content">
      <div class="auth__content-inner">
        <h1 class="auth__heading">Quản Trị Viên</h1>
        <p class="auth__desc">
          Chào mừng quản trị viên trở lại để đăng nhập.
        </p>
        <form class="form auth__form" @submit.prevent="login">
          <div class="form__group">
            <div class="form__text-input" style="height: 55px;">
              <input type="email" name="" placeholder="Email" class="form__input" required id="email" v-model="email" style="margin: auto; "/>
          ...
          <div class="form__group">
            <div class="form__text-input" style="height: 55px;">
              <input type="password" name="" placeholder="Password" class="form__input" required id="password" style="margin: auto;"
                v-model="password" />
          ...
          <div class="form__group auth__btn-group">
            ...
            <button class="btn btn--outline auth__btn btn--no-margin">
              <img src="../assets/icons/google.svg" alt="" class="btn__icon icon"  style="width: 40px; height: 40px;"/>
...
html.dark {
  ...
  --menu-column-icon-color: brightness(0) saturate(100%) invert(95%) sepia(6%) saturate(527%) hue-rotate(180deg) brightness(107%) contrast(96%);
  --sidebar-bg: #292e39;
