  ...
  <div id="content-wrapper">
    <div class="container-fluid">
      ...
      <form method="post" @submit.prevent="addProduct">
        <h2 v-if="this.editingIndex === null" style="padding-left: 50px;">Thêm sản phẩm mới</h2>
        <h2 v-else>Sửa sản phẩm</h2>
        ...
        <div class="form-group row">
          ...
          <div class="col-md-12">
            <textarea name="description" id="description" rows="10" cols="80" v-model="newProduct.description"></textarea>
          </div>
